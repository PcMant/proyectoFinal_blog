...
class GetModel{
    ...
    static public function getDataSearch($table, $select, $linkTo, $search, $orderBy,$orderMode,$startAt,$endAt){
        ...
        Sin ordenar y sin limitar datos
        ============================*/
        $sql = "SELECT $select FROM $table WHERE $linkTo[0] LIKE '%$searchToArray[0]%'  $linkToText";

        /*=============================
        Ordenar datos sin limies
        ============================*/
        if($orderBy != null && $orderMode != null && $startAt == null && $endAt == null){
            $sql = "SELECT $select FROM $table WHERE $linkTo[0] LIKE '%$searchToArray[0]%' $linkToText ORDER BY $orderBy $orderMode";
        }
        ...
        ============================*/
        if($orderBy != null && $orderMode != null && $startAt != null && $endAt != null){
            $sql = "SELECT $select FROM $table WHERE $linkTo[0] LIKE '%$searchToArray[0]%'  $linkToText ORDER BY $orderBy $orderMode LIMIT $startAt,$endAt";
        }
        ...
        ============================*/
        if($orderBy != null && $orderMode == null && $startAt != null && $endAt != null){
            $sql = "SELECT $select FROM $table WHERE $linkTo[0] LIKE '%$searchToArray[0]%'  $linkToText LIMIT $startAt,$endAt";
        }
